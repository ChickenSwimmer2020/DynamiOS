...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DynamicOS", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("DynamicOS", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "ChickenSwimmer2020";
		app.meta["file"] = "DynamicOS";
		app.meta["name"] = "DynamiOS";
